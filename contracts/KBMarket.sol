...
// we will bring in the openzeppelin ERC72 NFT functionality

import '@openzeppelin/contracts/token/ERC721/ERC721.sol';
import '@openzeppelin/contracts/security/ReentrancyGuard.sol';
import '@openzeppelin/contracts/utils/Counters.sol';
// security against tarnsactions for multiple requests
...
contract KBMarket is ReentrancyGuard {
    ...
    uint256 listingPrice = 0.00045 ether;
    ...
    // listen to events rom front end applications
    ...
    function fetchMyNFTs() public view returns (MarketToken[] memory) {
        ...
        // check to see if the owner address is equl to msg.sender
